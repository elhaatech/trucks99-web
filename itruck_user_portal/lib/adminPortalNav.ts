...
export function getAdminPortalNavDefinitions(
  ...
  return [
    ...
    {
      id: "load",
      label: getLabel("load", role, "Load"),
      getHref: () => routes.load.list(),
      appFolder: "load/list",
    },
    {
      id: "material",
      label: getLabel("material", role, "Materials"),
      getHref: () => routes.material.list(),
      appFolder: "material/list",
    },
    {
      id: "vehicleType",
      label: getLabel("vehicleType", role, "Vehicle Types"),
      getHref: () => routes.vehicleType.list(),
      appFolder: "vehicle-type/list",
    },
    {
      id: "vehicleBodyType",
      label: getLabel("vehicleBodyType", role, "Vehicle Body Types"),
      getHref: () => routes.vehicleBodyType.list(),
      appFolder: "vehicle-body-type/list",
    },
    {
      id: "truck",
      label: getLabel("truck", role, "Trucks"),
      getHref: () => routes.truck.list(),
      appFolder: "truck/list",
    },
    {
