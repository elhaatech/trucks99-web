...
export function createAppTheme(): Theme {
  return createTheme({
    ...
    typography: {
      ...
      h1: { fontSize: "clamp(2.5rem, 1.5rem + 4vw, 6rem)", fontWeight: TYPOGRAPHY.weights.extrabold, letterSpacing: "-0.03em", lineHeight: 1.15 },
      h2: { fontSize: "clamp(2rem, 1.2rem + 3vw, 3.75rem)", fontWeight: TYPOGRAPHY.weights.extrabold, letterSpacing: "-0.025em", lineHeight: 1.2 },
      h3: { fontSize: "clamp(1.75rem, 1rem + 2.5vw, 3rem)", fontWeight: TYPOGRAPHY.weights.bold, letterSpacing: "-0.02em", lineHeight: 1.25 },
      h4: { fontSize: "clamp(1.5rem, 0.9rem + 2vw, 2.125rem)", fontWeight: TYPOGRAPHY.weights.bold, letterSpacing: "-0.02em", lineHeight: 1.3 },
      h5: { fontSize: "clamp(1.25rem, 0.8rem + 1.5vw, 1.5rem)", fontWeight: TYPOGRAPHY.weights.bold, letterSpacing: "-0.01em", lineHeight: 1.35 },
      h6: { fontSize: "clamp(1.125rem, 0.75rem + 1.2vw, 1.25rem)", fontWeight: TYPOGRAPHY.weights.semibold, letterSpacing: "-0.01em", lineHeight: 1.4 },
      subtitle1: { fontSize: "clamp(1rem, 0.85rem + 0.5vw, 1.125rem)", fontWeight: TYPOGRAPHY.weights.medium, lineHeight: 1.5 },
      subtitle2: { fontSize: "clamp(0.875rem, 0.75rem + 0.4vw, 1rem)", fontWeight: TYPOGRAPHY.weights.medium, lineHeight: 1.45 },
      body1: { fontSize: "clamp(1rem, 0.85rem + 0.5vw, 1.125rem)", fontWeight: TYPOGRAPHY.weights.regular, lineHeight: 1.6 },
      body2: { fontSize: "clamp(0.875rem, 0.75rem + 0.4vw, 1rem)", fontWeight: TYPOGRAPHY.weights.regular, lineHeight: 1.55 },
      caption: { fontSize: "clamp(0.75rem, 0.7rem + 0.2vw, 0.875rem)", fontWeight: TYPOGRAPHY.weights.regular, lineHeight: 1.45 },
      overline: {
        fontWeight: TYPOGRAPHY.weights.bold,
        letterSpacing: "0.08em",
        fontSize: "clamp(0.6875rem, 0.6rem + 0.2vw, 0.75rem)",
        textTransform: "uppercase",
      },
      button: { fontSize: "clamp(0.9375rem, 0.85rem + 0.3vw, 1.0625rem)", textTransform: "none", fontWeight: TYPOGRAPHY.weights.semibold, letterSpacing: "0.01em" },
    },
    shape: {
