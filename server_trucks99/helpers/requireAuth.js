...
const PUBLIC_METHOD_PATHS = [
 ...
 { method: "GET", path: "/api/location/countries/all" },
  ...
  { method: "GET", path: "/api/contact/info" },
  { method: "POST", path: "/api/contact/submit" },
  { method: "GET", path: "/api/legal/terms" },
  { method: "GET", path: "/api/legal/privacy" },
  { method: "POST", path: "/api/legal" },
  { method: "GET", path: "/api/category/all" },
  { method: "GET", path: "/api/sub-category/all" },
  { method: "POST", path: "/api/sub-category/all" },
  { method: "GET", path: "/api/specifications" },
