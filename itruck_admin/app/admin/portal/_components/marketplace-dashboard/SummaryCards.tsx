...
export function SummaryCards({
  ...
  const cards: {
    ...
    },
    {
      ...
      subtitle: "Listed and in-deal inventory",
      icon: <CheckCircleOutlineIcon />,
      accent: "success",
      onClick: () => router.push(routes.buysell.list()),
      trendKey: "activeProducts",
    },
    {
    ...
    {
      title: "Sold Products",
      value: data?.soldProducts ?? 0,
      subtitle: `${formatCount(data?.periodCounts?.soldProducts)} sold in period`,
      icon: <SellOutlinedIcon />,
      accent: "secondary",
      onClick: () => router.push(routes.buysell.purchasedList()),
      trendKey: "soldProducts",
    },
    {
      title: "Rejected Products",
      value: data?.rejectedProducts ?? 0,
      subtitle: "Not approved for listing",
      icon: <HighlightOffOutlinedIcon />,
      accent: "error",
      trendKey: "rejectedProducts",
    },
    {
      title: "Total Users",
