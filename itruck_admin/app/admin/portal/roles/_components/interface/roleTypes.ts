...
const SUPER_ADMIN_MODULE_ORDER: { key: string; title_name: string }[] = [
  ...
  { key: "agent", title_name: "Agent" },
  { key: "transporter", title_name: "Transporter" },
  { key: "shipper", title_name: "Shipper" },
  { key: "loads", title_name: "Loader" },
  { key: "trucks", title_name: "Truck" },
  { key: "loadtype", title_name: "Load Type" },
  { key: "vehicletype", title_name: "Vehicle Type" },
  { key: "vehiclebodytype", title_name: "Vehicle Body Type" },
...
> = {
  ...
  agent: { create: true, view: true, update: true, delete: true },
  transporter: { create: true, view: true, update: true, delete: true },
  shipper: { create: true, view: true, update: true, delete: true },
  loads: { create: true, view: true, update: true, delete: true },
  trucks: { create: true, view: true, update: true, delete: true },
  loadtype: { create: true, view: true, update: true, delete: true },
  vehicletype: { create: true, view: true, update: true, delete: true },
  vehiclebodytype: { create: true, view: true, update: true, delete: true },
